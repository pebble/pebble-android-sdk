/*
 * This file has been cherry-picked from the Guava release v14.0 to cut dependencies to the
 * full Guava library.
 *
...
package com.getpebble.android.kit.guava;

import static com.getpebble.android.kit.guava.Preconditions.checkArgument;
import static com.getpebble.android.kit.guava.Preconditions.checkNotNull;
import static com.getpebble.android.kit.guava.UnsignedInts.INT_MASK;
import static com.getpebble.android.kit.guava.UnsignedInts.compare;
import static com.getpebble.android.kit.guava.UnsignedInts.toLong;
...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    public UnsignedInteger dividedBy(UnsignedInteger val) {
        return fromIntBits(UnsignedInts.divide(value, Preconditions.checkNotNull(val).value));
    }
    ...
    public UnsignedInteger mod(UnsignedInteger val) {
        return fromIntBits(UnsignedInts.remainder(value, Preconditions.checkNotNull(val).value));
    }
